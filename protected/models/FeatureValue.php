...
class FeatureValue extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('feature_id, value_id', 'required'),
			array('feature_id, value_id', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, feature_id, value_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'value' => array(self::BELONGS_TO, 'Value', 'value_id'),
			'products' => array(self::MANY_MANY, 'Product', 'feature_value_product(feature_value_id, product_id)'),
		);
	}
